This a general guide on how to build a custom Commander deck for playing on Cockatrice in a casual yet competitive setting. Our goal is to win, but we avoid strategies or cards that prevent others from playing or make the game trivial.
...
- Decency
  ...
  Don't chose an indecent Commander/Strategy that your playgroup won't want to play against. In my playgroup we don't like mechanics/strategies that revolve around reducing other players ability to play the game. Exemple: [Grand Arbitrer Augustin IV](https://scryfall.com/card/2x2/221/grand-arbiter-augustin-iv), [Iona](https://scryfall.com/card/mm2/20/iona-shield-of-emeria)
- Strategy
...
To know what are the different strategies for your commander, you can check the page of your Commander on [EdhRec](https://edhrec.com/). Then when you'll have set your mind on your Commander, proudly add it as the first card in your deck.
...
Let's explain unfamiliar keywords:
...
Let's see what I can learn from those numbers:
...
When all is set and done I recommend you to analyze the power level of your commander in a web tool: here is [one](https://edhpowerlevel.com/) among others.
...
### Tune your deck
Congratulation, you now have a playable deck! You can leave that section for after you 1st played your deck if you want. Don't forget to come back later to this guide.
